...
br.register('tokens-zrc20', (brs, location) => {
    brs.parent('tokens')
    brs.push('ZRC20 Token', location)
})
br.register('tokens-zrc21', (brs, location) => {
    brs.parent('tokens')
    brs.push('ZRC21 Token', location)
})
...
br.register('tokentxs', (brs) => {
    brs.parent('index')
    brs.push('Token (ZRC20) Transfers', { name: 'tokentxs' })
})
br.register('tokentxs-nft', (brs) => {
    brs.parent('index')
    brs.push('Token (TRC721) Transfers', { name: 'tokentxs-nft' })
})
br.register('tokentxs-zrc21', (brs) => {
    brs.parent('index')
    brs.push('Token (ZRC21) Transfers', { name: 'tokentxs-zrc21' })
})
